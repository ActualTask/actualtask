class Myprofile::CustomerTasksController < Myprofile::MyprofileController
  ...
  def task_params
    params.require(:task).permit(:title, :start_time, :end_time, :body, :all_tags, :price, :price_max, :price_min, :category_id, :any_price, :remote_attachments_url, :remove_attachments, {attachments: []},  :locations_attributes => [:id, :address, :_destroy] )
  end
